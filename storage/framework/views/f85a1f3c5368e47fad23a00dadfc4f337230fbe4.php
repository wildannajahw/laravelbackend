...
<div class="row">
  <div class="col-md-8">
    <form action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data" class="shadow-sm p-3 bg-white">
      <?php echo csrf_field(); ?>
      <input type="text" class="form-control <?php echo e($errors->first('title') ? "is-invalid" : ""); ?>" name="title" placeholder="Product name"><br>
      <div class="invalid-feedback">
        <?php echo e($errors->first('title')); ?>

      </div>
      <br>
      <input type="file" class="form-control <?php echo e($errors->first('cover') ? "is-invalid" : ""); ?>" name="cover"><br>
      <div class="invalid-feedback">
      ...
      <input type="number" class="form-control <?php echo e($errors->first('price') ? "is-invalid" : ""); ?>"  name="price" id="price" placeholder="Product price"><br>
      <div class="invalid-feedback">
